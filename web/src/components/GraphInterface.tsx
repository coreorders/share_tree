...
export default function GraphInterface() {
    ...
    return (
        <div className="relative w-screen h-screen bg-slate-900 overflow-hidden text-slate-100">
            ...
            {/* Footer */}
            <div className="fixed bottom-3 left-1/2 -translate-x-1/2 z-50 text-[10px] text-slate-500/80 flex items-center gap-1.5 pointer-events-auto bg-slate-900/40 px-3 py-1.5 rounded-full backdrop-blur-sm border border-slate-700/30 whitespace-nowrap">
                <span>제작자 :</span>
